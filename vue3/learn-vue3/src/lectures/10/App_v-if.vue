<template>
    <div>
        ...
        <h2 v-else>flase 입니다.</h2>
        <button v-on:click="visible = !visble">else로 글씨 바꾸기</button>
        <hr />
        ...
        <hr />
        <h1 v-show="showOk">Title 입니다.</h1>
        <button v-on:click="showOk = !showOk">show toggle</button>
    </div>
</template>
